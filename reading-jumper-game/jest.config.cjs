...
module.exports = {
  ...
  collectCoverageFrom: [
    'assets/scripts/services/{Analytics,CampaignProgress,GameSession,MediaAudioPlayer,QuestionBank,QuestionCursor,QuestionSchema,QuestionService,RoundTimer}.ts',

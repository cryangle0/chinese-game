...
```text
PUBLIC_ROOT=/srv/writing-treasure/web-mobile
BANK_FILE=/srv/writing-treasure/config/question-bank.json
ANALYTICS_FILE=/srv/writing-treasure/data/analytics/events.jsonl
PORT=8082
...
- `/health` 返回 `ok=true`。
- 微信、Safari、Chrome、作业帮 WebView 可进入挖宝。
